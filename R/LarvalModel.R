...
# Adults all: 0.6607 pruned: 0.66821 (all are max cv) allsimp: 0.675
# Larvae all: 0.813 pruned: 0.801 allsimp: 0.805
# Eggs all: 0.774 pruned: 0.7501 allsimp: 0.761

#10 logs####


##TODO####
#Finalise predator index and use that, NOT inc bluefin
